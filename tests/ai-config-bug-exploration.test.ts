...
describe('Bug Condition Exploration: AI Configuration Persistence', () => {
  ...
  test('should persist API keys (googleAiStudioKey, openAiKey)', async () => {
    ...
    const updateData = {
      aiConfiguration: {
        googleAiStudioKey: 'dummy_google_key_SyTest123456789',
    ...
    expect(updated).toBeDefined();
    expect(updated!.aiConfiguration).toBeDefined();
    expect(updated!.aiConfiguration?.googleAiStudioKey).toBe('dummy_google_key_SyTest123456789');
    ...
    expect(retrieved).toBeDefined();
    expect(retrieved!.aiConfiguration).toBeDefined();
    expect(retrieved!.aiConfiguration?.googleAiStudioKey).toBe('dummy_google_key_SyTest123456789');
