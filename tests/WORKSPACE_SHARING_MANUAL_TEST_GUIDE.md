...
3. Configure the following settings:
   ...
   - Google AI Studio Key: `dummyKey_test_key_12345` (or your actual key)
...
- [ ] Google AI Studio Key: `dummyKey_test_key_12345` ✓ (may be masked for security)
...
2. Verify AI generation receives key:
   ...
   # Expected: "Using API key: dummyKey..."
