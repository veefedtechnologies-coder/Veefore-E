...
3. Configure the following settings:
   ...
   - Google AI Studio Key: `dummy_google_key` (or your actual key)
...
- [ ] Google AI Studio Key: `dummy_google_key` ✓ (may be masked for security)
...
2. Verify AI generation receives key:
   ...
   # Expected: "Using API key: dummy_google_key..."
