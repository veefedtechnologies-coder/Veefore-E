...
describe.skip('InstagramPreview Integration Tests', () => {
  const mockPostData = {
    id: '123',
    type: 'post' as const,
  ...
  it.skip('should display placeholder when no post selected', () => {
    render(<InstagramPreview />);
    expect(screen.getByText('Select a post to preview')).toBeInTheDocument();
  });

  it.skip('should render with post data', () => {
    render(
      <InstagramPreview
  ...
  it.skip('should render DM preview mode', () => {
    render(
      <InstagramPreview
  ...
  it.skip('should render automation status indicator', () => {
    render(
      <InstagramPreview
        selectedPost={mockPostData}
        automationType="comment_dm"
