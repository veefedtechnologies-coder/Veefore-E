        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            rafId = requestAnimationFrame(() => {
                ...
                if (gradientRef.current) {
                    gradientRef.current.style.background = `radial-gradient(ellipse at ${x}% ${y}%, rgba(76,130,247, 0.15) 0%, transparent 50%)`;
                }
            });
        };
        ...
        <section ref={sectionRef} className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
            <div className="absolute inset-0">
                <div
                    ...
                    style={{
                        background: 'radial-gradient(ellipse at 50% 50%, rgba(76,130,247, 0.15) 0%, transparent 50%)'
                    }}
                />

                <FloatingOrb size={400} color="rgba(76,130,247,0.1)" delay={0} duration={20} className="top-[10%] left-[10%]" />
                <FloatingOrb size={300} color="rgba(59,130,246,0.1)" delay={2} duration={25} className="top-[60%] right-[5%]" />
                <FloatingOrb size={200} color="rgba(127,168,255,0.08)" delay={4} duration={18} className="bottom-[20%] left-[20%]" />
                ...
                <div
                    ...
                    style={{
                        background: `linear-gradient(to top, rgba(76,130,247, 0.1), transparent),
            ...
            <div className="relative z-10 max-w-[1200px] mx-auto px-6 text-center">
                <Perspective3D className="inline-block mb-8">
                    <motion.div
                        ...
                        style={{
                            background: 'linear-gradient(135deg, rgba(76,130,247,0.2) 0%, rgba(59,130,246,0.2) 100%)',
                            border: '1px solid rgba(76,130,247,0.3)',
                            boxShadow: '0 20px 40px -20px rgba(76,130,247,0.5), inset 0 1px 0 rgba(255,255,255,0.1)',
                    ...
                    >
                        ...
                        >
                            <Rocket className="w-5 h-5 text-[#7FA8FF]" />
                        </motion.div>
                ...
                >
                    <h2
                        ...
                        style={{
                            textShadow: '0 0 80px rgba(76,130,247,0.3)'
                        }}
                    >
                        <span className="block text-white">Be the first</span>
                        <span className="block bg-gradient-to-r from-[#4C82F7] via-[#7FA8FF] to-[#5EE6C4] bg-clip-text text-transparent">
                            to experience
                        </span>
                ...
                <Perspective3D className="inline-block mb-12">
                    ...
                    >
                        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                            <div className="p-2 sm:p-3 rounded-xl bg-[#4C82F7]/20 border border-[#4C82F7]/30">
                                <Calendar className="w-5 h-5 sm:w-6 sm:h-6 text-[#7FA8FF]" />
                            </div>
                ...
                >
                    <motion.button
                        whileHover={{ scale: 1.05, boxShadow: '0 0 40px rgba(76,130,247,0.4)' }}
                        whileTap={{ scale: 0.98 }}
                        className="group relative px-8 py-4 rounded-2xl bg-gradient-to-r from-[#4C82F7] to-[#3461C7] text-white font-semibold text-lg overflow-hidden gpu-stable"
                    ...
                    >
                        ...
                        <motion.div
                            className="absolute inset-0 bg-gradient-to-r from-[#5E93FF] to-[#4C82F7] gpu-stable"
                            initial={{ x: '-100%' }}
                            whileHover={{ x: 0 }}
    ...
    const particles = useMemo(() => [...Array(8)].map((_, i) => {
        ...
        return {
            ...
            background: i % 2 === 0
                ...
                : 'radial-gradient(circle, rgba(76,130,247,0.8) 0%, transparent 70%)',
            boxShadow: i % 2 === 0
                ? '0 0 20px 8px rgba(59,130,246,0.3)'
                : '0 0 20px 8px rgba(76,130,247,0.3)',
            yAnim: [0, -20 - (i * 5), 0],
            duration: 3 + (i * 0.3),
            delay: i * 0.2
        };
        ...
        >
            <div className="sticky top-0 h-screen overflow-hidden">
                ...
                <motion.div
                    ...
                    style={{
                        background: 'radial-gradient(ellipse at center, rgba(10,22,40,0.55) 0%, transparent 70%)',
                        ...GPU_STYLE
                    }}
                >
                    <div className="absolute inset-0 pointer-events-none overflow-hidden">
                        ...
                        <div className="absolute right-[5%] bottom-[10%] w-[35vw] h-[35vw] rounded-full bg-gradient-to-tl from-[#4C82F7]/12 to-[#7FA8FF]/8 blur-[80px]" style={GPU_STYLE} />
                        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[60vw] rounded-full bg-gradient-to-r from-[#4C82F7]/10 to-transparent blur-[100px]" style={GPU_STYLE} />
                    </div>
                ...
                >
                    <motion.div
                        ...
                        style={{
                            scale: revealScale,
                            background: 'radial-gradient(circle, rgba(59,130,246,0.15) 0%, rgba(76,130,247,0.1) 30%, rgba(76,130,247,0.05) 50%, transparent 70%)',
                            filter: 'blur(40px)',
                        }}
                    />
                    ...
                    <motion.div
                        ...
                        style={{
                            ...
                            boxShadow: '0 0 60px 20px rgba(59,130,246,0.1), inset 0 0 40px rgba(76,130,247,0.05)',
                        }}
                    />
                    ...
                    <motion.div
                        ...
                        style={{
                            ...
                            border: '1px solid rgba(76,130,247,0.2)',
                        }}
                    />
                </motion.div>
                ...
                >
                    <div className="absolute inset-0" style={GPU_STYLE}>
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/20 via-transparent to-[#0A1A3A]/20 mix-blend-overlay" />
                    </div>
                </motion.div>
                    ...
                    >
                        ...
                        >
                            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
                                {/* skeleton-guard-allow: status-dot — decorative 'Beta Access' marketing accent dot */}
                        ...
                        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
                            The Future of
                            <span className="block mt-2 bg-gradient-to-r from-[#5EE6C4] via-[#7FA8FF] to-[#4C82F7] bg-clip-text text-transparent">
                                Content Creation
                            </span>
                        </h1>
...
function BetaLaunchSection() {
    return (
        <div id="beta" className="min-h-screen overflow-x-clip">
            <Hero3D />
            <ScrollZoomIntro />
            <UrgencySection />
            <SignupSection />
